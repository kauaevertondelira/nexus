...
import { initializeApp } from "https://www.gstatic.com/firebasejs/10.12.2/firebase-app.js";
        ...
        window.deleteOs = (id) => {
            Swal.fire({ title: 'Eliminar O.S.?', text: "Este registro será apagado.", icon: 'warning', showCancelButton: true, confirmButtonText: 'Sim', cancelButtonText: 'Cancelar', ...getSwalTheme() })
